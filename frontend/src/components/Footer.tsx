...
const Footer = () => {
  ...
  return (
    <footer className="gradient-bg text-gray-400 py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            >
              ...
              <p className="mb-4">
                Collaborative playlist app that makes parties more fun and
                interactive.
              </p>
            </motion.div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">
            &copy; {currentYear} Let's Vibe. All rights reserved.
          </p>
